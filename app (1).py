...
def main():
    ...
    with col_s2:
        st.markdown("""<div class="step-card">
          ...
          <div class="step-text"><strong>Vérifiez les transactions</strong><br><small>Prévisualisation interactive complète</small></div>
        </div>""", unsafe_allow_html=True)
    with col_s3:
        st.markdown("""<div class="step-card">
    ...
    for uploaded_file in uploaded_files:
        ...
        # ── Tableau interactif ─────────────────────────────────────────────────
        st.markdown('<div class="section-header" style="margin-top:1.2rem">🔍 Prévisualisation des transactions</div>', unsafe_allow_html=True)
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "Débit":   st.column_config.TextColumn("💸 Débit",   width=115),
                "Crédit":  st.column_config.TextColumn("💰 Crédit",  width=115),
            }
        )
        ...
        with col_dl2:
            ...
            <div style="padding:0.6rem 0; font-size:0.83rem; color:#7489b0; line-height:1.7;">
              ...
              &nbsp;&nbsp;·&nbsp;&nbsp;
              <b style="color:#0f2d6b">{len(txns)} transactions</b>
              &nbsp;&nbsp;·&nbsp;&nbsp;

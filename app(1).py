...
def parse_sg_afrique(pages_words, pages_text, _pdf_path=''):
    ...
    for pw in pages_words:
        ...
        while i < len(rows):
            ...
            # SGBS : Débit x0≈430-500, Crédit x0≈510+
            # Zones mesurées sur PDF réel
            ...
            if nb == 1:
                # Un seul montant : position x décide (frontière 510)
                val, x0 = resolved[0]
                if x0 >= 510:
                    credit_amt = val
                else:
                ...
                # [mouvement, rien] ou [débit, crédit] - jamais de solde dans SGBS
                val, x0 = resolved[0]
